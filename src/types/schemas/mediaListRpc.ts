...
const MediaListRpcRowSchema = z.object({
  ...
  media_product_type: z.string().nullable(),
  created_at: z.string(),
  updated_at: z.string(),
  ...
  insights_views: NullableNumberLikeSchema.optional(),
  insights_total_interactions: NullableNumberLikeSchema.optional(),
  insights_profile_activity: NullableNumberLikeSchema.optional(),
  insights_replies: NullableNumberLikeSchema.optional(),
  insights_reposts: NullableNumberLikeSchema.optional(),
  insights_reels_skip_rate: NullableNumberLikeSchema.optional(),
  insights_crossposted_views: NullableNumberLikeSchema.optional(),
  insights_facebook_views: NullableNumberLikeSchema.optional(),
  insights_completion_rate: NullableNumberLikeSchema.optional(),
  ...
  return parsedRows.map((row) => {
    ...
    if (row.insights_id) {
      media.insights = {
        ...
        views: row.insights_views ?? null,
        total_interactions: row.insights_total_interactions ?? null,
        profile_activity: row.insights_profile_activity ?? null,
        replies: row.insights_replies ?? null,
        reposts: row.insights_reposts ?? null,
        reels_skip_rate: row.insights_reels_skip_rate ?? null,
        crossposted_views: row.insights_crossposted_views ?? null,
        facebook_views: row.insights_facebook_views ?? null,
        completion_rate: row.insights_completion_rate ?? null,
