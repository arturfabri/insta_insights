...
npx supabase functions deploy instagram-oauth --project-ref rsnqdfqlzqteagancgvc --no-verify-jwt
npx supabase functions deploy instagram-oauth-facebook --project-ref rsnqdfqlzqteagancgvc --no-verify-jwt
